...
const insertShiftRecordService = async (serviceId, employeeId) => {
    ...
    const [pedido] = await pool.query(
        ...
        t.type AS Tipo_Servicio, t.city AS Provincia, s.validationCode, s.totalPrice AS Precio_Total, s.date AS Fecha, s.startTime ASHora_Inicio, a.address AS Dirección, a.postCode AS CP, a.city AS Ciudad, u.email AS Email
        FROM addresses a
